...
public class ControlPanelElements {
    ...
    public ViewInteraction switcherNotActive = onView(allOf(withId(R.id.switcher), withText("Not active OFF")));
    ...
    public ViewInteraction messageDelete = onView(withId(R.id.message));
